...
Your persistent memory lives at `agents/brains/evangeline-tan.md`. Read it at the start of every project and update it during nightly reflection (created in Plan 1 Task 3.1; wired up in Phase 2).
